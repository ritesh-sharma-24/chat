...
import com.ritesh.chat.databinding.ActivityGroupChatBinding;
...
public class GroupChatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //get message from db and show on RecyclerView
        ...
        binding.sendImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (binding.etMessage.getText().toString().isEmpty()){
                    ...
                    Toast.makeText(GroupChatActivity.this, "Enter Text", Toast.LENGTH_SHORT).show();
                    return;
                }
